// patchsets/154/linux/STUB-install-identity.cc
// ============================================================================
// Linux 临时 stub — 仅在 Windows-only patch 拆分场景下使用。
// ============================================================================
//
// 背景:
...
//   当 Linux 上只 apply cross patch 时，BUILD.gn 会去编译这个 .cc 文件，
//   但 Linux 端没有该文件，导致 autoninja 失败。
//
//   解决方案：把本 stub 文件放到 src/chrome/browser/r0_license/
//   install_identity_win.cc 位置（覆盖 Windows-only patch 没有被 apply 的
//   缺失）。也可以在 Linux 上使用 install_identity_linux.cc 替代。
//
// ============================================================================
